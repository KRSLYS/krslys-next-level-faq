...
(function () {
  ...
  registerBlockType(blockName, {
    edit: function (props) {
      ...
      const presetOptions = [{
        label: __('Use global preset', 'next-level-faq'),
        value: ''
      ...
      const groupOptions = [{
        label: __('All FAQs (default)', 'next-level-faq'),
        value: 0
      ...
      return el(Fragment, null, el(InspectorControls, null, el(PanelBody, {
        title: __('FAQ Settings', 'next-level-faq'),
        initialOpen: true
      }, el(TextControl, {
      ...
      }, el(Spinner)) : el(SelectControl, {
        label: __('FAQ Group', 'next-level-faq'),
        value: groupId || 0,
        options: groupOptions,
        onChange: function (value) {
          setAttributes({
            groupId: parseInt(value || 0, 10) || 0
          });
        }
      }))), el('div', blockProps, el('div', {
        className: 'nlf-faq nlf-faq--editor-placeholder'
      }, el('h2', {
        className: 'nlf-faq__title'
      }, title || __('Frequently Asked Questions', 'next-level-faq')), el('p', null, groupId ? __('This block will display the selected FAQ group on the front-end.', 'next-level-faq') : __('No specific group selected. Default FAQs will be shown.', 'next-level-faq')), el('p', {
        className: 'description'
      }, activePreset ? __('Preset: ', 'next-level-faq') + (presetRegistry[activePreset] ? presetRegistry[activePreset].name : activePreset) : __('Using global preset', 'next-level-faq')))));
    },
    save: function () {
