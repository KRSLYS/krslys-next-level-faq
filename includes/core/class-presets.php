	...
	public static function get_registry() {
		return array(
			...
			'minimal'  => array(
				...
				'description' => __( 'Clean and subtle. Works with any design.', 'next-level-faq' ),
				'values'      => array(
			...
			'modern'   => array(
				...
				'description' => __( 'Floating cards with indigo accent and soft elevation.', 'next-level-faq' ),
				'values'      => array(
					'container_background'    => '#ffffff',
			...
			'card'     => array(
				...
				'description' => __( 'Stacked connected items with clean borders.', 'next-level-faq' ),
				'values'      => array(
					'container_background'    => '#ffffff',
			...
			'outline'  => array(
				...
				'description' => __( 'No borders. Answers marked with left accent bar.', 'next-level-faq' ),
				'values'      => array(
					'container_background'    => '#ffffff',
			...
			'contrast' => array(
				...
				'description' => __( 'Dark surface with orange accent. Bold statement.', 'next-level-faq' ),
				'values'      => array(
